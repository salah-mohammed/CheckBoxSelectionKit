...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://bitbucket.org/salahmohamd/pagekit"
  ...
  s.source       = { :git => "https://salahmohamd@bitbucket.org/salahmohamd/pagekit.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "*", "CheckBoxSelectionKit/*"
